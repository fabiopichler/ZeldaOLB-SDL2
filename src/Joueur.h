...
class Joueur : public Personnage {
    ...
    private :
        ...
        int cle[14][4]; // clés dans donjon i, 0 : carte, 1 : boussole, 2 : clé boss, 3 : clés
        int coffre[15][35]; //14 donjons + coffres extérieurs
        bool explore[14][20][10]; //lieux explorés dans les donjons
